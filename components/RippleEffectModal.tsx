...
export const RippleEffectModal: React.FC<RippleEffectModalProps> = ({ isOpen, onClose }) => {
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-md overflow-hidden border border-slate-200 dark:border-slate-700 animate-scale-in">
                ...
                <div className="p-8 text-center">
                    <p className="text-slate-500 dark:text-slate-400">
                        Ripple effect simulation visualizes how a failure propagates through the network.
                        <br /><br />
